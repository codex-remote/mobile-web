...
- Adopted Apache License 2.0, organization-wide contribution guidance, CI, and Dependabot updates.
...
- Pairing QR output now defaults to a large square-cell terminal renderer so iPhone cameras do not depend on terminal font metrics; compact and small renderers remain explicit space-saving options.
